...
a = Analysis(
    ...
    hiddenimports=['pyarmor_runtime_000000', 'json', 'os', 'platform', 'sqlite3', 'hashlib', 'uuid', 'subprocess', 'time', 'urllib.request', 'urllib.error', 'tkinter', 'tkinter.ttk', 'tkinter.messagebox', 'tkinter.scrolledtext', 'pathlib', 'secrets'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
