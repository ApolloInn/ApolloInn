...
# 模块级共享 httpx client，用于 token refresh（避免每次新建连接）
_shared_auth_client: Optional[httpx.AsyncClient] = None

def _get_auth_client() -> httpx.AsyncClient:
    """获取或创建共享的 auth httpx client。"""
...
from core.utils import get_machine_fingerprint
